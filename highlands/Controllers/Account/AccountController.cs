...
namespace highlands.Controllers.Account
{
    public class AccountController : Controller
    {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                if (roleData != null)
                {
                    ...
                    try
                    {
                        ...
                        // Ki?m tra c? UserId và RoleId t? Redis
                            ...
                            roleObj.UserId != null && int.TryParse(roleObj.UserId.ToString(), out userId))
                        {
                            ...
                            // Ki?m tra password t? DB ngay c? khi có cache
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            // Chuy?n h??ng ng??i dùng v? trang login ho?c trang ch?
        ...
        public async Task<IActionResult> GoogleResponse(string returnUrl = null)
        {
            ...
            if (email != null)
            {
                using (var connection = new SqlConnection(_connectionString))
                {
                    ...
                    {
                        // N?u ng??i dùng ?ã t?n t?i, c?p nh?t thông tin ph??ng th?c ??ng nh?p
